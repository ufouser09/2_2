...
void rotateByRight(NODE **phead,int counter);
void rotateByLeft(NODE **phead,int counter);
NODE *create_node();
...
//-----------------------------------------------------------------
	...
	rotateByLeft(&head2,counter1);

}
else{
	
	printf("ikinci dizimiz saða %d kadar gidicek\n",counter1);
	rotateByRight(&head2,counter1);
...
if(c2==1){
	...
	rotateByLeft(&head3,counter2);

}else{
	
	printf("üçüncü dizimiz saga %d kadar gidicek\n",counter2);
	rotateByRight(&head3,counter2);
