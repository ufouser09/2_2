...
void findNumbers(NODE *head1,NODE *head2,NODE *head3,int **c1,int **c2,int **counter1,int **counter2,int M);
...
findNumbers(head1,head2,head3,&c1,&c2,&counter1,&counter2,M);
